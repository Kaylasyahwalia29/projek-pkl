        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-5">
                <div class="intro-excerpt">
                    <h1>Welcome to<span class="d-block">Pet Harmony</span></h1>
                    <p class="mb-4">centers related to pets, from equipment to food services.</p>
                    <p><a href="{{url('produk')}}" class="btn btn-secondary me-2">Shop Now</a></p>
                </div>
            </div>
            <div class="col-lg-7">
                <div class="hero-img-wrap text-lg-end">
                    <img src="{{ asset('front/assets/images/petshop3.png') }}"
                        style="max-height: 400px; margin-left: 170px; margin-top: -150px" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
